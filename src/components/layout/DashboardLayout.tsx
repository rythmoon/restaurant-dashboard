          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-xl sm:text-2xl font-black bg-gradient-to-r from-red-500 to-amber-500 bg-clip-text text-transparent">
                    Mary's Restaurant
                  </h1>
          ...
          <div className="lg:hidden bg-white/95 backdrop-blur-lg border-t border-white/30">
            <div className="px-4 py-3 space-y-3">
              ...
              <div className="flex space-x-2">
                <button className="flex-1 text-center p-3 bg-red-50 rounded-lg text-sm font-medium text-red-700">
                  Configuración
                </button>
                <button
                  onClick={handleLogout}
